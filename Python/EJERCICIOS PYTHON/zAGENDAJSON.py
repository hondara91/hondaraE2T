...
class Agenda:
    ...
    def cargar_json(self):
        try:
            with open("agenda.json", "r", encoding="utf-8") as archivo:
                datos = json.load(archivo)

                for contacto_dic in datos:
                    contacto = Contacto(
                        contacto_dic["nombre"],
                        contacto_dic["telefono"],
                        contacto_dic["direccion"],
                        contacto_dic["empleo"]
                    )
    ...
    def guardar_json(self):
        ...
        for contacto in self.lista:
            datos.append(contacto.a_diccionario())
